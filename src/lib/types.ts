...
// Enums from database
export const CourseStatusEnum = z.enum(["planned", "completed", "not_started"]);
...
export const RequirementGroupSchema = z.object({
    ...
    coursesRequired: z.array(z.string()),
